<!-- Profile grid -->
<form role="form" id="target" method="POST" action="<?php echo base_url(); ?>sales-order/save-lengkapi-data/<?php echo $sales_order_id; ?>">
<div class="row">
    ...
    <div class="container" style="max-width: 800px;  padding-top:0">
        <div class="col-lg-12">  
            <div class="tabbable page-tabs text-center">
                ...
                <h1>FORM LENGKAPI DATA<br><?php echo $sales_order_no; ?><br><br></h1>
                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content with-padding">
                                <div class="tab-pane fade in active" id="justified-tab1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group" id="group-long_tempat_akad">
                                                <label>Longitude<span class="label_danger">*</span></label>
                                                <input type="text" class="form-control" value="<?php echo isset($data->long_tempat_akad)?$data->long_tempat_akad:''; ?>" name="long_tempat_akad" id="long_tempat_akad">
                                                <i id="alert-long_tempat_akad" class="icon icon-warning form-control-feedback hidden"></i>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group" id="group-lat_tempat_akad">
                                                <label>Latitude<span class="label_danger">*</span></label>
                                                <input type="text" class="form-control" value="<?php echo isset($data->lat_tempat_akad)?$data->lat_tempat_akad:''; ?>" name="lat_tempat_akad" id="lat_tempat_akad">
                                                <i id="alert-lat_tempat_akad" class="icon icon-warning form-control-feedback hidden"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group" id="group-long_tempat_resepsi">
                                                <label>Longitude<span class="label_danger">*</span></label>
                                                <input type="text" class="form-control" value="<?php echo isset($data->long_tempat_resepsi)?$data->long_tempat_resepsi:''; ?>" name="long_tempat_resepsi" id="long_tempat_resepsi">
                                                <i id="alert-long_tempat_resepsi" class="icon icon-warning form-control-feedback hidden"></i>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group" id="group-lat_tempat_resepsi">
                                                <label>Latitude<span class="label_danger">*</span></label>
                                                <input type="text" class="form-control" value="<?php echo isset($data->lat_tempat_resepsi)?$data->lat_tempat_resepsi:''; ?>" name="lat_tempat_resepsi" id="lat_tempat_resepsi">
                                                <i id="alert-lat_tempat_resepsi" class="icon icon-warning form-control-feedback hidden"></i>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-content with-padding">
                                <div class="tab-pane fade in active" id="justified-tab1">
                                    ...
                                    <div class="form-group">
                                        <label>Perbedaan Waktu</label>
                                        <input type="text" name="gmt_diff" value="<?php echo isset($data->gmt_diff)?$data->gmt_diff:''?>" class="form-control" value="https://kiniwedding.com/inv/">
                                    </div>
