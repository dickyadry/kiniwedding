<?php 
    ...
    $url_action = base_url()."sales-order/product-images/update/".$sales_order_id.'/'.encrypt_decrypt('encrypt',$data->id);
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group" id="group-caption">
                ...
                <div class="col-sm-10">
                    <input type="text" name="caption" value="<?php echo isset($data->caption)?$data->caption:''; ?>" class="form-control"  id="caption" disabled>
                </div>
            </div>
            <div class="form-group" id="group-width">
                <label class="col-sm-2 control-label">Width</label>
                <div class="col-sm-10">
                    <input disabled type="text" name="width" value="<?php echo isset($data->width)?$data->width:''; ?>" class="form-control"  id="width" onkeyup="cekForm('width')">
            ...
            <div class="form-group" id="group-height">
                ...
                <div class="col-sm-10">
                    <input type="text" name="height" value="<?php echo isset($data->height)?$data->height:''; ?>" class="form-control"  id="height" onkeyup="cekForm('height')" disabled>
            ...
            <div class="form-group" id="group-order">
                ...
                <div class="col-sm-10">
                    <input type="text" name="order" value="<?php echo isset($data->order)?$data->order:1; ?>" class="form-control"  id="order" onkeyup="cekForm('order')" disabled>
                        ...
                        <div class="thumbnail">
                            <div class="thumb">
                                ...
                                <?php if(isset($data->image) && $data->image!=null){?>
                                    <img id="gambar" alt="Event Stack" src="<?php echo $data->image; ?>">
                                <?php }else{ ?>
                                ...
                                <div class="thumb-options">
                                    <span>
                                        ...
                                        <input type="hidden" id="cover" name="image" value="<?php echo isset($data->image)?$data->image:''; ?>">
            ...
            <div class="form-features text-right">
                ...
                <a href="<?php echo base_url();?>sales-order/product-images/<?php echo $sales_order_id; ?>">
