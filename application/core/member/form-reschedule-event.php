...
<form role="form" method="POST" action="<?php echo base_url(); ?>member/event/reschedule/<?php echo encrypt_decrypt('encrypt',$data->id); ?>" onsubmit="return validateForm()">
<div class="row">
                                ...
                                <div class="tab-pane fade in active" id="justified-tab1">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <div class="col-sm-6 has-feedback" id="group-start-date">
                                                        <input type="text" class="datetime-picker-start_date form-control" id="start-date" value="<?php echo isset($data->start_date)?$data->start_date:''; ?>" name="start_date" placeholder="Tanggal mulai event" onchange="cekForm('start-date')" >
                                                        <i class="icon-calendar2 form-control-feedback"></i>
                                                    </div>
                                                    <div class="col-sm-6 has-feedback" id="group-end-date">
                                                        <input type="text" class="datetime-picker-end_date form-control" id="end-date" value="<?php echo isset($data->end_date)?$data->end_date:''; ?>" name="end_date" placeholder="Tanggal berakhir event" onchange="cekForm('end-date')" >
                                                        <i class="icon-calendar2 form-control-feedback"></i>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-horizontal" >
                                        <div class="form-group" id="group-reason">
                                            <div class="col-sm-12">
                                                <label>Alasan Perubahan Jadwal</label>
                                                <div class="row">
                                                    <div class="col-sm-12 has-feedback">
