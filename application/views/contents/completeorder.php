    ...
    <div class="container text-center">
        <div>
            <div class="col-xs-12">
                ...
                <?php if($data->status_order!=1 && $data->payment_method!="manual"){ ?>
                <div class="payment__status__box">

                    <?php if($data->payment_method=='gopay'){?>
                        <h4>Scan QRCODE dibawh ini <br>untuk melakukan pembayaran</h4>
                        <img src="<?php echo $data->payment_code; ?>" style="max-width: 300px; margin:10px;">
                    <?php } ?>

                    <div class="form__footer payment__footer">
                        Segera Lalukan Pembayaran Dalam Waktu
                        <br><br>
                        <div class="row">
                            <div class="col-4">
                                <div class="box_time">
                        ...
                        <br>
                        <?php if(strtolower($data->payment_method)=='indomaret' || strtolower($data->payment_method)=='alfamart'){?>
                        Segera kunjungi <?php echo strtolower(($data->payment_method)) ; ?> terdekat untuk menyelesaikan pembayaran, tunjukan kode pembayaran kepada kasir sebagai nomor tagihan pembelian tiket di EVENTSTACK
                        <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box_payment">
                                Kode Pembayaran: <span class="code_payment"><?php echo str_replace("#", '<br>', $data->payment_code); ?> <?php $arr=explode("#",$data->payment_code); echo (count($arr)>1)?'(Midtrans)':''; ?></span>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="box_payment">
                                Metode Pembayaran: <span class="code_payment"><?php echo str_replace("_", " ", strtoupper($data->payment_method)) ; ?></span>
                            </div>
                        </div>
                    </div>
                ...
                <?php }else if($data->status_order!=1 && $data->payment_method=="manual"){ ?>
                <div class="payment__status__box">
