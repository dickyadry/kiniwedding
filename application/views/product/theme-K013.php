...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo $product->code; ?>/<?php echo ASSETS . "img/logo-only-hitam.png";?>">
...
<body>
        ...
        <nav class="navbar" id="nav">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/index.html">True <i class="fa fa-heart"></i> Love</a>
                </div>
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#home">Home</a></li>
                        <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#couple">Couple</a></li>
                        <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#story">Story</a></li>
                        <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#event">Events</a></li>
                        <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#gallery">Gallery</a></li>
                        ...
                        <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#people">People</a></li>
                        <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#gift">Gift</a></li>
                        <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#rsvp">RSVP</a></li>
                        <li class="dropdown">
                            <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#" role="button" aria-haspopup="true" aria-expanded="false">Blog <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/blog.html">Blog Style-1</a></li>
                                <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/blog-2.html">Blog Style-2</a></li>
                                <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/blog-details.html">Blog Details</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#" role="button" aria-haspopup="true" aria-expanded="false">Pages <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/404.html">404 Page</a></li>
                                <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/coming-soon.html">Coming Soon</a></li>
            ...
            <div class="row content">
                <div class="col col-sm-6 left-col">
                    <div class="col col-xs-6 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                        ...
                        <h3>Romeo</h3>
                        <h4>The groom</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorum culpa hic in maxime perferendis modi. Nihil porro inventore similique quisquam ipsam illum, beatae eius.</p>
                        <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/announcement/signature-1.png" alt="Signature" class="img img-reponsive signature">
                    </div>
                </div>
                <div class="col col-sm-6 right-col">
                    <div class="col col-xs-6 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                        ...
                        <h4>The bride</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorum culpa hic in maxime perferendis modi. Nihil porro inventore similique quisquam ipsam illum, beatae eius.</p>
                        <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/announcement/signature-2.png" alt="Signature" class="img img-reponsive signature">
                    </div>
                </div>
            </div> <!-- end of content -->
    ...
    <section class="video-bg">
        ...
        <div class="row">
            <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/https://www.youtube.com/watch?v=y6PH9u0wnww" class="btn btn-default">
            ...
            <div class="content">
                <div class="row" id="first-row">
                    ...
                    <div class="col col-md-8">
                        ...
                        <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#">Read more</a>
                    </div>
                </div>
                ...
                <div class="row" id="last-row">
                    <div class="col col-md-4">
                        <div class="event-frame">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/event/frame.png" alt="Event Frame" class="">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/event/img-3.jpg" alt="Event Picture" class="">
                        </div>
                    </div>
                    <div class="col col-md-8">
                        <h3>The Greeting</h3>
    ...
    <section class="gallery section-padding" id="gallery">
        ...
        <div class="row content">
            <ul id="filter">
                <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#" class="active" data-group="all">All</a></li>
                <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#" data-group="engagement">Engagement</a></li>
                <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#" data-group="wedding">Wedding</a></li>
                <li><a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#" data-group="honeymoon">Honeymoon</a></li>
            </ul>
                ...
                <div class="col col-xs-6 col-sm-3">
                    <div class="frame">
                        <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-frame.png" alt="Frame" class="img img-responsive hidden-xs">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-frame-sm.png" alt="Frame" class="img img-responsive hidden-lg hidden-md hidden-sm show-xs">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-1.jpg" alt="Image" class="img img-responsive">
                        </a>
                        <div class="overlay">
                ...
                <div class="col col-xs-6 col-sm-3">
                    <div class="frame">
                        <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-frame.png" alt="Frame" class="img img-responsive hidden-xs">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-frame-sm.png" alt="Frame" class="img img-responsive hidden-lg hidden-md hidden-sm show-xs">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-2.jpg" alt="Image" class="img img-responsive">
                        </a>
                        <div class="overlay">
                            <div><span>Grooms</span></div>
                        </div>
                ...
                <div class="col col-xs-6 col-sm-3">
                    <div class="frame">
                        <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-frame.png" alt="Frame" class="img img-responsive hidden-xs">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-frame-sm.png" alt="Frame" class="img img-responsive hidden-lg hidden-md hidden-sm show-xs">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-3.jpg" alt="Image" class="img img-responsive">
                        </a>
                        <div class="overlay">
                ...
                <div class="col col-xs-6 col-sm-3">
                    <div class="frame">
                        <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-frame.png" alt="Frame" class="img img-responsive hidden-xs">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-frame-sm.png" alt="Frame" class="img img-responsive hidden-lg hidden-md hidden-sm show-xs">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/groomsmen-bridesmaids/img-4.jpg" alt="Image" class="img img-responsive">
                        </a>
                        <div class="overlay">
                            <div><span>Bridesmaids</span></div>
                        </div>
    ...
    <section class="gift-registration section-padding" id="gift">
        <div class="container">
            ...
            <div class="row content gift-slider">
                <div class="item">
                    <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/gift/img-1.png" alt="Gift Registry" class="img img-responsive">                
                </div>
                <div class="item">
                    <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/gift/img-2.png" alt="Gift Registry" class="img img-responsive">                
                </div>
                <div class="item">
                    <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/gift/img-3.png" alt="Gift Registry" class="img img-responsive">                
                </div>
                <div class="item">
                    <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/gift/img-1.png" alt="Gift Registry" class="img img-responsive">                
                </div>
        ...
        <div class="container">
            ...
            <div class="row content">
                ...
                <div class="col col-sm-4">
                    <div class="frame">
                        <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/journal/frame.png" alt="Frame" class="frame-main">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/journal/frame-sm.png" alt="Frame" class="frame-sm">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/journal/img-1.jpg" alt="Journal" class="main-img">
                ...
                <div class="col col-sm-4">
                    <div class="frame">
                        <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/journal/frame.png" alt="Frame" class="frame-main">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/journal/frame-sm.png" alt="Frame" class="frame-sm">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/journal/img-2.jpg" alt="Journal" class="main-img">
                            <div class="hover-title">
                                <div>
                                    <span>Wedding Preparations</span>
                                </div>
                ...
                <div class="col col-sm-4">
                    <div class="frame">
                        <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/journal/frame.png" alt="Frame" class="frame-main">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/journal/frame-sm.png" alt="Frame" class="frame-sm">
                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/home/journal/img-3.jpg" alt="Journal" class="main-img">
                            <div class="hover-title">
                                <div>
                                    <span>Wedding Preparations</span>
                                </div>
                ...
                <div class="link">
                    <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#" class="btn btn-default">Load More</a>
                    <a href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/#" class="btn btn-default">See Journal</a>
                </div>
                </div>
            </div> <!-- end of content -->
