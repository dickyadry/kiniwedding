...
<div class="wd_slider_wrapper ">
			...
			<div class="wd_mainmenu_wrapper">
				<div class="wd_main_menu_wrapper">
					<div class="wd_main_menu wd_single_index_menu">
						<ul>
							<li><a href="http://webstrot.com/html/wedding/home_1/0">Home</a></li>
							<li><a href="http://webstrot.com/html/wedding/home_1/1">About Us</a></li>
							<li><a href="http://webstrot.com/html/wedding/home_1/2">Love Story</a></li>
							<li><a href="http://webstrot.com/html/wedding/home_1/3">Events</a></li>
							<li><a href="http://webstrot.com/html/wedding/home_1/4">Rsvp</a></li>
							<li><a href="http://webstrot.com/html/wedding/home_1/5">Family</a></li>
							<li><a href="http://webstrot.com/html/wedding/home_1/6">Gallery</a></li>
							<li><a href="http://webstrot.com/html/wedding/home_1/7">Blog</a></li>
							<li><a href="http://webstrot.com/html/wedding/home_1/8">Contact Us</a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<ul>
		<li><a href="http://webstrot.com/html/wedding/home_1/1" id="headbottom"><i class="fa fa-long-arrow-down" aria-hidden="true"></i></a></li>
	</ul>
	</div>
</div>
</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col-lg-pull-4 col-md-pull-4 col-sm-pull-0">
				<div class="wd_about_infobox">
					...
					<div class="wd_btn wd_single_index_menu_rsvp">
						<a href="http://webstrot.com/html/wedding/home_1/4">rsvp</a>
					</div>
				</div>
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="wd_story_covers">
					...
					<div class="wd_story_covers_box_left">
						<div class="wd_story_dot"><span></span></div>
						<div class="wd_story_covers_box_img">
							<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/story_5.jpg" alt="Story">
						</div>
						<div class="wd_story_covers_box_datails">
							<span>23 Nov 2020</span>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				...
				<div class="wd_guest_slider">
					<div class="owl-carousel owl-theme">
						<div class="item"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/gue1.png" alt="Slider" class="img-responsive"></div>
						<div class="item"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/gue2.png" alt="Slider" class="img-responsive"></div>
						<div class="item"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/gue3.png" alt="Slider" class="img-responsive"></div>
						<div class="item"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/gue1.png" alt="Slider" class="img-responsive"></div>
						<div class="item"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/gue2.png" alt="Slider" class="img-responsive"></div>
						<div class="item"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/gue3.png" alt="Slider" class="img-responsive"></div>
						<div class="item"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/gue1.png" alt="Slider" class="img-responsive"></div>
		...
		<div class="row">
			...
			<div class="wd_family_tabbox">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#groom" aria-controls="groom" role="tab" data-toggle="tab"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/tab1.jpg" alt="Groom"><p>Mark</p></a></li>
					<li role="presentation"><a href="#bride" aria-controls="bride" role="tab" data-toggle="tab"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/tab2.jpg" alt="Bride"><p>Jenny</p></a></li>
				</ul>
				<!-- Tab panes -->
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="wd_family_infobox">
											<div class="wd_family_infobox_img">
												<span><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/line2.png" alt="Line"></span>
												<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/fm1.jpg" alt="Family">
											</div>
								...
								<div class="item">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="wd_family_infobox">
											<div class="wd_family_infobox_img">
												<span><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/line2.png" alt="Line"></span>
												<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/fm2.jpg" alt="Family">
											</div>
								...
								<div class="item">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="wd_family_infobox">
											<div class="wd_family_infobox_img">
												<span><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/line2.png" alt="Line"></span>
												<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/fm3.jpg" alt="Family">
											</div>
											<h2>Carolyn</h2>
											<p>(Mark’s Sister)</p>
											<ul>
								...
								<div class="item">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="wd_family_infobox">
											<div class="wd_family_infobox_img">
												<span><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/line2.png" alt="Line"></span>
												<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/fm4.jpg" alt="Family">
											</div>
											<h2>Donald</h2>
											<p>(Mark’s Brother)</p>
											<ul>
								...
								<div class="item">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="wd_family_infobox">
											<div class="wd_family_infobox_img">
												<span><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/line2.png" alt="Line"></span>
												<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/fm5.jpg" alt="Family">
											</div>
											<h2>Mr. Clark Wills</h2>
											<p>(Jenny’s Father)</p>
											<ul>
								...
								<div class="item">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="wd_family_infobox">
											<div class="wd_family_infobox_img">
												<span><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/line2.png" alt="Line"></span>
												<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/fm6.jpg" alt="Family">
											</div>
											<h2>Jeniffer Wills</h2>
											<p>(Jenny’s Mother)</p>
											<ul>
								...
								<div class="item">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="wd_family_infobox">
											<div class="wd_family_infobox_img">
												<span><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/line2.png" alt="Line"></span>
												<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/fm7.jpg" alt="Family">
											</div>
											<h2>Carolyn</h2>
											<p>(Jenny’s Sister)</p>
											<ul>
								...
								<div class="item">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="wd_family_infobox">
											<div class="wd_family_infobox_img">
												<span><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/line2.png" alt="Line"></span>
												<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/fm8.jpg" alt="Family">
											</div>
											<h2>Donald</h2>
											<p>(Jenny’s Brother)</p>
											<ul>
		...
		<div class="row">
			...
			<div class="wd_blog_box">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="wd_blog_img">
						<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/blog1.jpg" alt="Blog">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="wd_blog_info">
						...
						<ul>
							<li><a href="#"><i class="fa fa-calendar-o" aria-hidden="true"></i> 23 Nov 2020</a></li>
			...
			<div class="wd_blog_box">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-lg-push-6 col-md-push-6 col-sm-push-6">
					<div class="wd_blog_img">
						<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/blog2.jpg" alt="Blog">
					</div>
				</div>
			...
			<div class="wd_blog_box">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="wd_blog_img">
						<img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/content/blog3.jpg" alt="Blog">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="wd_blog_info">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/js/custom.js"></script>
<script>
