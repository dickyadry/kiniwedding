...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/css/custom.css">
...
<body>
		...
		<div class="wd_slider_wrapper ">
			...
			<div class="wd_header_wrapper wd_single_index_menu">
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="wd_logo">
						<img src="<?php echo ASSETS . "img/wedding-black.jpeg";?>" alt="Logo" title="Logo" class="img-responsive" style="height:100px;">
	...
	<div class="wd_footer_bottom_wrapper wd_toppadder50 wd_bottompadder50 finish">
