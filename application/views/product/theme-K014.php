...
<body id="home">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/slider/slide-4.jpg">
                            <div class="container">
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/slider/1.jpg">
                            <div class="container">
                                <div class="slide-content">
                                    <div data-swiper-parallax="200" class="slide-subtitle">
                                        <h4>WERE GETTING MARRIED</h4>
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/slider/slide-3.jpg">
                            <div class="container">
                                <div class="slide-content">
                                    <div data-swiper-parallax="200" class="slide-subtitle">
                                        <h4>WERE GETTING MARRIED</h4>
                        ...
                        <div class="col-md-6 col-sm-6 grid couple-single">
                            <div class="couple-wrap">
                                <div class="couple-img">
                                    <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/story/1.jpg" alt="">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-6 couple-single md-0 grid">
                            <div class="couple-wrap">
                                <div class="couple-img couple-img-2">
                                    <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/story/2.jpg" alt="">
                                </div>
                                <div class="couple-text">
                                    <div class="couple-content">
                                        <h4>Millar Wiliam</h4>
                    ...
                    <div class="col col-xs-12">
                        <div class="story-timeline">
                            <div class="row">
                                ...
                                <div class="col col-md-6">
                                    <div class="img-holder">
                                        <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/story/img-1.jpg" alt class="img img-responsive">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col col-md-6">
                                    <div class="img-holder right-align-text story-slider">
                                        <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/story/img-3.jpg" alt class="img img-responsive">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                             ...
                                             <div class="event-wrap">
                                                <div class="row">
                                                    <div class="col-md-5 col-12">
                                                        <div class="event-img">
                                                            <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/events/img-1.jpg" alt>
                                                        </div>
                                                    </div>
    ...
    <script src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/js/swiper.min.js"></script>
