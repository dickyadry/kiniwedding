                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 hidden-xs">
                        <div class="main-menu menu_scroll">
                            <nav>
                                <ul>
                                    <li><a href="http://webstrot.com/html/wedding/05_winter_wedding/0">home</a></li>
                                    <li><a href="http://webstrot.com/html/wedding/05_winter_wedding/1">about us</a></li>
                                    <li><a href="http://webstrot.com/html/wedding/05_winter_wedding/2">Love Story</a></li>
                                    <li><a href="http://webstrot.com/html/wedding/05_winter_wedding/3">Events</a></li>
                                    <li><a href="http://webstrot.com/html/wedding/05_winter_wedding/4">Gallery</a></li>
                                    <li><a href="http://webstrot.com/html/wedding/05_winter_wedding/5">Blog</a></li>
                                    <li><a href="http://webstrot.com/html/wedding/05_winter_wedding/6">Contact Us</a></li>
                                    <li><a href="http://webstrot.com/html/wedding/05_winter_wedding/7" class="btn1">rspv</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="mobile-menu menu_scroll visible-xs">
                    <nav>
                        <ul>
                            ...
                            <li><a href="http://webstrot.com/html/wedding/05_winter_wedding/5">Blog</a></li>
                            <li><a href="http://webstrot.com/html/wedding/05_winter_wedding/6">Contact Us</a></li>
                            <li><a href="http://webstrot.com/html/wedding/05_winter_wedding/7">rspv</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="content">
                                                ...
                                                <h3 class="wow animated fadeInUp" data-wow-duration="1s">23/11/2020</h3><br>
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-4">
                        <div class="persons">
                            ...
                            <div class="content">
                                <a href="#"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/about/1.png" alt=""/></a>
                    ...
                    <div class="col-md-5 col-sm-4">
                        <div class="persons">
                            ...
                            <div class="content">
                                <a href="#"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/about/2.png" alt=""/></a>
                                <h4>( S/o Mrs fariza & Mr. jany )</h4>
                                <p>Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit connec.</p>
                                <ul class="socials">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="family-tabbox">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#groom" aria-controls="groom" role="tab" data-toggle="tab"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/family/sm-1.jpg" alt=""/></a></li>
                                <li role="presentation"><a href="#bride" aria-controls="bride" role="tab" data-toggle="tab"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/family/sm-2.jpg" alt=""/></a></li>
                            </ul>
                            <!-- Nav tabs End-->
                                ...
                                <div role="tabpanel" class="tab-pane fade in active" id="groom">
                                    <div class="familyslider">
                                        ...
                                        <div class="item col-md-3 col-sm-6">
                                            <figure><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/family/5.jpg" alt=""/></figure>
                                            <div class="content">
                                                <h2>Jonsina Kplix</h2>
                                                <p>(Joahn’s Brother)</p>
                                            </div>
                                        ...
                                        <div class="item col-md-3 col-sm-6">
                                            <figure><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/family/6.jpg" alt=""/></figure>
                                            <div class="content">
                                                <h2>Palxia Kplix</h2>
                                                <p>(Joahn’s Sister)</p>
                                            </div>
                                        ...
                                        <div class="item col-md-3 col-sm-6">
                                            <figure><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/family/7.jpg" alt=""/></figure>
                                            <div class="content">
                                                <h2>Mr. Plera Kplex </h2>
                                                <p>(Joahn’s Brother)</p>
                                            </div>
                                        ...
                                        <div class="item br_rn col-md-3 col-sm-6">
                                            <figure><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/family/8.jpg" alt=""/></figure>
                                            <div class="content">
                                                <h2>Mr. Plera Kplex </h2>
                                                <p>(Joahn’s Sister)</p>
                                            </div>
                        ...
                        <div class="reg-con">
                            <div class="con">
                               <h2>You’re Invited <span>Jenny & Mark</span> Wedding</h2>
                                <p>Please Rsvp Before <span>23 Nov 2020</span></p>
                            ...
                            <div class="reg-slider">
                                <div class="list-slider">
                                    <a href="#"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/brand/1.jpg" alt=""/></a>
                                    <a href="#"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/brand/2.jpg" alt=""/></a>
                                </div>
                                <div class="list-slider">
                                    <a href="#"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/brand/3.jpg" alt=""/></a>
                                    <a href="#"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/brand/1.jpg" alt=""/></a>
                                </div>
                                <div class="list-slider">
                                    <a href="#"><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/brand/1.jpg" alt=""/></a>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4">
                        <div class="events line">
                            ...
                            <div class="con">
                                <ul>
                                    <li><i class="fas fa-calendar-alt"></i><span>23 Nov 2020</span></li>
            ...
            <div class="container">
                ...
                <div class="row" id="blog">
                    <div class="col-md-4 col-sm-6 bitem">
                        <div class="blogs">
                            <figure>
                                <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/blog/1.jpg" alt=""/>
                                <div class="date">
                                    <strong>22</strong>
                                    <span>Nov</span>
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 bitem">
                        <div class="blogs">
                            <figure>
                                <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/blog/2.jpg" alt=""/>
                                <div class="date">
                                    <strong>22</strong>
                                    <span>Nov</span>
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 bitem">
                        <div class="blogs">
                            <figure>
                                <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/blog/3.jpg" alt=""/>
                                <div class="date">
                                    <strong>22</strong>
                                    <span>Nov</span>
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 bitem">
                        <div class="blogs">
                            <figure>
                                <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/blog/4.jpg" alt=""/>
                                <div class="date">
                                    <strong>22</strong>
                                    <span>Nov</span>
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 bitem">
                        <div class="blogs">
                            <figure>
                                <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/blog/5.jpg" alt=""/>
                                <div class="date">
                                    <strong>22</strong>
                                    <span>Nov</span>
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 bitem">
                        <div class="blogs">
                            <figure>
                                <img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/blog/6.jpg" alt=""/>
                                <div class="date">
                                    <strong>22</strong>
                                    <span>Nov</span>
                                </div>
        ...
        <section class="contact-info section2">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-4">
                        <div class="info-list">
                            <span><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/icons/3.png" alt=""/></span>
                            <div class="con">
                                <h2>Location</h2>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="info-list">
                            <span><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/icons/4.png" alt=""/></span>
                            <div class="con">
                                <h2>Contact</h2>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="info-list">
                            <span><img src="<?php echo base_url(); ?>assets/<?php echo $product->code; ?>/images/icons/5.png" alt=""/></span>
                            <div class="con">
                                <h2>Email</h2>
