...
function buku_tamu() {
    ...
    if(document.getElementById("nama").value=="" || document.getElementById("nama").value==" "){
        Swal.fire(
          'Oopps!',
          'Nama harus diisi',
          'error'
        ...
        return false;
    }else if(document.getElementById("status").value=="" || document.getElementById("status").value==" "){
        Swal.fire(
          'Oopps!',
          'Status harus diisi',
          'error'
        ...
        return false;
    }else if(document.getElementById("pesan").value=="" || document.getElementById("pesan").value==" "){
